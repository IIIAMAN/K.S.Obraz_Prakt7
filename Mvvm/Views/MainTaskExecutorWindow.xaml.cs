...
{
    public partial class MainTaskExecutorWindow : Window
    {
        public MainTaskExecutorWindow(string currentUserLogin)
        {
            InitializeComponent();
            DataContext = new MainTaskExecutorViewModel(currentUserLogin);
        }
